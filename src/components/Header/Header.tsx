        ...
        >
            <div className='container'>
                ...
                <div className='grid grid-cols-12 gap-4 mt-4 items-end'>
                    <Link to='/' className='col-span-12 lg:col-span-2'>
                    ...
                    <form
                        className='flex items-center col-start-1 col-span-10 lg:col-span-8 lg:col-start-3 bg-white h-10 pt-1 pb-1 ps-3 pe-1 rounded-sm'
